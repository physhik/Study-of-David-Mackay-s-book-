...
\end{tabular}}
\caption[The plot of exercise 27.1]{\label{laplace} \small The blue plot is Poisson distribution and the orange one is the Laplace approximation. Look into the plot around the maximum. Very well matched around the tip.  }
\end{figure}
