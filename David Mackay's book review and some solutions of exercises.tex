...
$$
$$
3. Ising model is also useful as a statistical model in its own right.

\subsection{Direct computation of partition function of Ising models}
We concentrate on models that have the form of a long thin strip of width W with periodic boundary conditions in both directions
$$
$$
W : width of the strip. 
$$
$$
C : length of the strip.  
$$
$$
WC = the volume of the strip. 
$$
$$
free energy per spin in the limit of an infinite thin strip :  $f = -kT~ln~\mu_{max}/W $
$$
$$
$\mu_{max}$ : the largest eigenvalue of the matrix, $M_{ss'}$. Look at the definition of $M$ at (31.28), (31.29).
