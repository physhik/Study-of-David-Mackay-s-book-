...
$$
$$
Answer : Let us solve a simple random walk problem with 2 degrees of freedom(back and forward). With the size of the step, $w$ and the number of the turns, $N$, the maximum reaching distance will be $\sqrt{N w}$. 

To change the position of x from $(0,~1)$ to (1,11)$, the probability is $1/10$ from the density funcions. 
\end{document}
